...
RESULT=$((echo -n '{"image_format": "jpg", "model_name":"militaryaircrafts.onnx", "image": "'; base64 ./test/testtest.jpg; echo '"}') | curl -H "Content-Type: application/json" -d @-  http://localhost:5000/api/v1/objectdetection)
echo $RESULT
